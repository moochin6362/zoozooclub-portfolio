...
## ⚙️ 제공하는 기능
- **로그인** : 이메일이 아이디가 되어 로그인이 가능하도록 구현 
- **회원가입** : 기존 사이트와 동일하게 이메일 회원가입을 하되,인증을 통하여 회원가입이 가능하도록 구현 
- **게시판** : 소통을 위한 게시판으로, 로그인 시 글 작성과 수정, 댓글 달기가 가능하도록 구현
- **관리자** : 회원 관리, 게시판 관리가 가능하도록 특정 로그인 정보에 관리자 기능 부여, 관리자 페이지를 따로 개발
- **쇼핑몰** : 상품 판매 기능 추가
회원 – 상품 구매 및 장바구니
관리자 – 상품 삭제,등록,수정
